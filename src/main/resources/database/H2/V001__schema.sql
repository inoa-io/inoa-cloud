CREATE TABLE tenant (
	...
	CONSTRAINT chk_tenant_external_id CHECK (external_id ~ '^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}'),
...
CREATE TABLE "group" (
	...
	CONSTRAINT chk_group_external_id CHECK (external_id ~ '^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}'),
...
CREATE TABLE gateway (
	...
	CONSTRAINT chk_gateway_external_id CHECK (external_id ~ '^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}'),
...
CREATE TABLE gateway_secret (
	...
	CONSTRAINT chk_gateway_secret_external_id CHECK (external_id ~ '^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}'),

...
import io.inoa.fleet.api.GroupsApiTestClient;
import io.inoa.fleet.api.GroupsApiTestSpec;
...
public class GroupsApiTest extends AbstractTest implements GroupsApiTestSpec {
	...
	public void findGroups200() {
		...
		assertTrue(groups.stream().noneMatch(group -> group.getGroupId().equals(otherGroup.getGroupId())), "tenant");
	}

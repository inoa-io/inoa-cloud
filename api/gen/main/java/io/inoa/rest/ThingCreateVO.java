...
public class ThingCreateVO {
	...
	public ThingCreateVO description(org.openapitools.jackson.nullable.JsonNullable<java.lang.Object> newDescription) {
	...
	public ThingCreateVO measurands(java.util.List<@jakarta.validation.constraints.NotNull @jakarta.validation.Valid MeasurandVO> newMeasurands) {
		this.measurands = newMeasurands;
		return this;
	}
	
	public ThingCreateVO addMeasurandsItem(MeasurandVO measurandsItem) {
	...
	public ThingCreateVO removeMeasurandsItem(MeasurandVO measurandsItem) {
		if (this.measurands != null) {

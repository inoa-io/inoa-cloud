...
public class ThingTypeUpdateVO {
	...
	public ThingTypeUpdateVO uiLayout(java.util.List<java.util.Map<String, java.lang.@jakarta.validation.constraints.NotNull @jakarta.validation.Valid Object>> newUiLayout) {
		this.uiLayout = newUiLayout;
		return this;
	}
	
	public ThingTypeUpdateVO addUiLayoutItem(java.util.Map<String, java.lang.Object> uiLayoutItem) {
	...
	public ThingTypeUpdateVO removeUiLayoutItem(java.util.Map<String, java.lang.Object> uiLayoutItem) {
		if (this.uiLayout != null) {

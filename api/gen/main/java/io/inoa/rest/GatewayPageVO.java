...
public class GatewayPageVO {
	...
	private java.util.List<GatewayVO> content = new java.util.ArrayList<>();
	...
	public GatewayPageVO content(java.util.List<GatewayVO> newContent) {
	...
	public java.util.List<GatewayVO> getContent() {
		return content;
	}

	public void setContent(java.util.List<GatewayVO> newContent) {
		this.content = newContent;
	}

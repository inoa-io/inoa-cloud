...
public class ThingPageVO {
	...
	private java.util.List<@jakarta.validation.constraints.NotNull @jakarta.validation.Valid ThingVO> content = new java.util.ArrayList<>();
	...
	public ThingPageVO content(java.util.List<@jakarta.validation.constraints.NotNull @jakarta.validation.Valid ThingVO> newContent) {
	...
	public java.util.List<@jakarta.validation.constraints.NotNull @jakarta.validation.Valid ThingVO> getContent() {
		return content;
	}

	public void setContent(java.util.List<@jakarta.validation.constraints.NotNull @jakarta.validation.Valid ThingVO> newContent) {
		this.content = newContent;
	}

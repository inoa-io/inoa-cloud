...
export class ThingsService {
	...
	): Observable<HttpResponse<ThingVO>>;
	public createThing(
		thingCreateVO: ThingCreateVO,
		observe?: "events",
		reportProgress?: boolean,
		options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
	): Observable<HttpEvent<ThingVO>>;
	public createThing(
		thingCreateVO: ThingCreateVO,
		observe: any = "body",
	...
	public downloadConfigToGateway(
		gatewayId: string,
		observe?: "response",
		reportProgress?: boolean,
		options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
	...
	public downloadConfigToGatewayLegacy(
		gatewayId: string,
		observe?: "response",
		reportProgress?: boolean,
		options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
	...
	public findThings(
		...
		reportProgress?: boolean,
		options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
	): Observable<HttpResponse<ThingPageVO>>;
	public findThings(
		page?: number,
		size?: number,
		sort?: Array<string>,
		...
		reportProgress?: boolean,
		options?: { httpHeaderAccept?: "application/json"; context?: HttpContext }
	): Observable<HttpEvent<ThingPageVO>>;
	public findThings(
		page?: number,
		size?: number,
		sort?: Array<string>,
	...
	public findThingsByGatewayId(
		...
		if (nameFilter !== undefined && nameFilter !== null) {
			localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>nameFilter, "name_filter");
		}
		if (referenceFilter !== undefined && referenceFilter !== null) {
			localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>referenceFilter, "reference_filter");
		}
	...
	public syncConfigToGatewaySequential(
		gatewayId: string,
		observe?: "response",
		reportProgress?: boolean,

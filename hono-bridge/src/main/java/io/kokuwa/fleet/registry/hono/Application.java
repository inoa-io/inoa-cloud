...
public class Application extends AbstractApplication {
	 ...
	 *             if service is {@code null}.
	 * @throws IllegalArgumentException
	 *             if the given service is not a {@code Verticle}.
	 */
	@Autowired
	...
	protected Future<?> deployRequiredVerticles(final int maxInstances) {
		...
		return deployVerticle(authService).onSuccess(id -> registerHealthCheckProvider(authService));
	}

...
public class JsonPathConverterTest extends AbstractConverterTest {
	...
	void success() {
		var raw = new TelemetryRawVO()
				...
				.value("{\"wifi_sta\":{\"connected\":true,\"ssid\":\"landskron\",\"ip\":\"192.168.178.50\",\"rssi\":-63},\"cloud\":{\"enabled\":false,\"connected\":false},\"mqtt\":{\"connected\":false},\"time\":\"10:55\",\"serial\":1,\"has_update\":false,\"mac\":\"483FDA1D3A03\",\"relays\":[{\"ison\":true,\"has_timer\":false,\"overpower\":false}],\"meters\":[{\"power\":53.79,\"is_valid\":true,\"timestamp\":1647255320,\"counters\":[46.361, 0.000, 0.000],\"total\":46}],\"temperature\":21.18,\"overtemperature\":false,\"update\":{\"status\":\"unknown\",\"has_update\":false,\"new_version\":\"\",\"old_version\":\"20190516-073020/master@ea1b23db\"},\"ram_total\":50832,\"ram_free\":40540,\"fs_size\":233681,\"fs_free\":171684,\"uptime\":72}"
						.getBytes());

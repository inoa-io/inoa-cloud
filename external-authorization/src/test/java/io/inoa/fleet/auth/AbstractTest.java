...
import io.inoa.fleet.auth.rest.HttpResponseAssertions;
import io.inoa.fleet.auth.rest.JwtProvider;
...
public abstract class AbstractTest {
	...
	public String auth(Tenant tenant) {
		return new JwtProvider(signature).builder().subject("admin").toBearer();
	}

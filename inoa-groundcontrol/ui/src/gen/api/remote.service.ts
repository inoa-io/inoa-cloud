...
// @ts-ignore
import { RpcCommand } from '../model/rpcCommand';
// @ts-ignore
...
export class RemoteService {
    ...
    public sendRpcCommand(gatewayId: string, rpcCommand: RpcCommand, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (rpcCommand === null || rpcCommand === undefined) {
            throw new Error('Required parameter rpcCommand was null or undefined when calling sendRpcCommand.');
        }
        ...
        return this.httpClient.request<RpcResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {

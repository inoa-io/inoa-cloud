...
class DVZEDvModbusIRBuilderTest {

	@Test
	void testBuildDefinitionLegacy() {
		DVZEDvModbusIRBuilder builder = new DVZEDvModbusIRBuilder(new ObjectMapper());
		Thing thing = new Thing();
		thing.setName("schrank");
		HashMap<String, Object> config = new HashMap<>();
		HashMap<String, Object> properties = new HashMap<>();
		HashMap<String, Object> channels = new HashMap<>();
		properties.put("dvmodbusir-serial", 22);
		properties.put("serial", "1DZG0024008206");
		...
		thingType.setThingTypeReference("dvmodbusir-dvze");
		...
		Optional<JsonNode> obis180 = items.stream()
				.filter(i -> i.get("header").get("id").asText().equals("urn:dvmodbusir-dvze:1DZG0024008206:0x000D"))
			.findFirst();

...
/**
 * Client to be used by external services. Use {@link MqttBroker#internalPublish(MqttPublishMessage,
 * String)} to publish internal messages.
 */
@AllArgsConstructor
public class MqttServiceClient {

  private final ObjectMapper mapper = new ObjectMapper();
  @Getter private final String clientId = MqttServiceClient.class.getName();
  private final MqttClient client;
  private final MqttConnectOptions options;

  @SuppressWarnings("resource") // memory persistence is not a real resource
  public MqttServiceClient(String url, String tenantId, String gatewayId, byte[] psk)

...
public class Security {
	...
	public UserVO getUser() {
		...
		// In case of a landlord, set the first associated landlord of the user as start point for the UI
		return new UserVO().firstname(firstname).lastname(lastname).email(email).sessionExpires(sessionExpires);
	}
	...
	private Authentication getAuthentication() {
		return securityService.getAuthentication().orElseThrow(() -> {

...
public class ConnectionEventListener {
	...
	private void handleOldEventType(
			String tenantId, String gatewayId, Integer ttd, Long timestampMillis) {
		...
		log.info(
				"Gateway {}/{} {}connected at {}", tenantId, gatewayId, ttd == -1 ? "" : "dis", timestamp);
	}

	private void handleNewEventType(
			String tenantId, String gatewayId, Long timestampMillis, String payload) {
		...
		log.info(
				"Gateway {}/{} {}connected at {}", tenantId, gatewayId, connected ? "" : "dis", timestamp);
	}
}

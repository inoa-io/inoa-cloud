...
public class RemotingService {
  ...
  public static final String COMMAND_TOPIC_FORMAT_STRING =
      MqttBroker.COMMAND_TOPIC_LONG_NAME + "/%s/%s/req/%s/cloudEventRpc";

  private final ObjectMapper mapper;
  private final MqttBroker mqttBroker;

  public void sendRpcCommand(String tenantId, String gatewayId, RpcCommandVO command)

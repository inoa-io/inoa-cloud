...
public class ConfigurationMapperTest {
  ...
  void toStringIntegerWithRestrictions() {
    var definition =
        new ConfigurationDefinition()
            .setType(ConfigurationTypeVO.INTEGER)
            .setMinimum(1)
            .setMaximum(5);
    assertString("4", definition, 4);
  }
  ...
  void toStringIntegerInvalidMinimum() {
    var definition =
        new ConfigurationDefinition().setType(ConfigurationTypeVO.INTEGER).setMinimum(4);
  ...
  void toStringIntegerInvalidMaximum() {
    var definition =
        new ConfigurationDefinition().setType(ConfigurationTypeVO.INTEGER).setMaximum(5);
  ...
  void toStringIntegerInvalidMinLength() {
    var definition =
        new ConfigurationDefinition().setType(ConfigurationTypeVO.STRING).setMinimum(4);
  ...
  void toStringIntegerInvalidMaxLength() {
    var definition =
        new ConfigurationDefinition().setType(ConfigurationTypeVO.STRING).setMaximum(5);
  ...
  void toStringIntegerInvalidPattern() {
    var definition =
        new ConfigurationDefinition().setType(ConfigurationTypeVO.STRING).setPattern("^[a-f]*$");
